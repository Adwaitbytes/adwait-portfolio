    ...
    <section id="craft" className="relative border-t border-white/5 py-20 md:py-40">
      <div className="container-rail">
        ...
        <motion.h2
          ...
          className="display-title mt-10 text-balance text-[13vw] leading-[0.95] md:text-[9vw] md:leading-[0.9] lg:text-[7.5vw]"
        >
          Opinionated, <br />
          not dogmatic.
        </motion.h2>
        ...
        <div className="mt-12 divide-y divide-white/10 border-y border-white/10 md:mt-16">
          {craft.map((c, i) => (
            <motion.div
              key={c.title}
              initial={{ opacity: 0, y: 16 }}
